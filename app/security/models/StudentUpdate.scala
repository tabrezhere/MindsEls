...
object StudentUpdate {
  /*implicit val restFormat = StudentUpdateFormat.restFormat*/
  
  implicit val reads: Reads[StudentUpdate] = (
     ...
     (JsPath \ "vehicleId").readNullable[Long])(StudentUpdate.apply(_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _)  
  )  
}


/*object StudentUpdateFormat {
  implicit val restFormat = (
    ...
    (__ \ "Studentadminno").format[String])(StudentUpdate.apply, unlift(StudentUpdate.unapply))
}*/