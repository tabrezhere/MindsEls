...
object GuardianSignUp {
  implicit val restFormat = GuardianSignUpFormat.restFormat
}


object GuardianSignUpFormat {
  implicit val restFormat = (
    ...
    (__ \ "stdadmissionno").format[String]) (GuardianSignUp.apply, unlift(GuardianSignUp.unapply))
}