...
object StaffUpdate {
 /* implicit val restFormat = StaffUpdateFormat.restFormat*/
  ...
  implicit val reads: Reads[StaffUpdate] = (
     ...
     (JsPath \ "vehicleId").readNullable[Long]) (StaffUpdate.apply(_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _)  
  ) 
  
}


/*object StaffUpdateFormat {
  implicit val restFormat = (
    ...
    (__ \ "campusId").format[Long]) (StaffUpdate.apply, unlift(StaffUpdate.unapply))
}*/