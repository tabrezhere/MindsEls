...
object LibrarianSignUp {
 /* implicit val restFormat = StaffSignUpFormat.restFormat*/
  
  implicit val reads: Reads[LibrarianSignUp] = (
     ...
     (JsPath \ "campusId").read[Long]) (LibrarianSignUp.apply(_, _, _, _,_,_,_,_,_,_,_,_,_,_)  
  ) 
