...
object LibrarianUpdate {
 /* implicit val restFormat = StaffUpdateFormat.restFormat*/
  
  implicit val reads: Reads[LibrarianUpdate] = (
     (JsPath \ "userId").read[Long] ~
     (JsPath \ "userLoginId").read[Long] ~
     (JsPath \ "userContextId").read[Long] ~
     (JsPath \ "librarianId").read[Int] ~
     ...
     (JsPath \ "campusId").read[Long]) (LibrarianUpdate.apply(_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _)  
  ) 
  
}


/*object LibrarianSignUpFormat {
